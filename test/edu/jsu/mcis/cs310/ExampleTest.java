...
public class ExampleTest {
    ...
    private String expectedReverse1, expectedReverse2, expectedReverse3, expectedMyTest;
    ...
    @Test
    public void myTest() {
        String actual = main.reverse("I love dogs");
        assertEquals(expectedMyTest, actual);
    }
